const topBarCenterText = `M0DPF - IO91sk`;
// Menu items
...
const aIMG = [
  ["RADAR", "https://s.w-x.co/staticmaps/wu/wu/satir1200_cur/europ/animate.png"],
  [
    "LOCAL RADAR",
    "https://s.w-x.co/staticmaps/wu/wu/satir1200_cur/uking/animate.png",
  ],
  [
    "NOAA D-RAP",
  ...
  [
    "T+24",
    "https://www.weathercharts.net/ukmo_mslp_prognosis/ppve.gif",
  ],
  [
    "LIGHTNING",
    "https://images.lightningmaps.org/blitzortung/europe/index.php?map=0",
  ],
  [
    "LIGHTNING LOCAL",
    "https://images.lightningmaps.org/blitzortung/europe/index.php?map=uk",
  ],
  ...
  ["10M PROPAGATION", "https://www.tvcomm.co.uk/g7izu/Autosave/EU_MUF_AutoSave.JPG"],
  ["HF PROPAGATION",
